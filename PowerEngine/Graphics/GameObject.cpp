...
void GameObject::ApplyScale()
{
	this->basicScale.x = this->scale.x;
	this->basicScale.y = this->scale.y;
	this->basicScale.z = this->scale.z;
	this->UpdateMatrix();
}

void GameObject::SetBasicScale(const XMFLOAT3& scale )
{
	this->basicScale.x = scale.x;
	this->basicScale.y = scale.y;
	this->basicScale.z = scale.z;
	this->UpdateMatrix();
}

void GameObject::SetScale(const XMFLOAT3& scale)
{
	this->scale.x = this->basicScale.x * scale.x;
	this->scale.y = this->basicScale.y * scale.y;
	this->scale.z = this->basicScale.z * scale.z;
	this->UpdateMatrix();
}

void GameObject::SetScale(float x, float y, float z)
{
	this->scale.x = this->basicScale.x * x;
	this->scale.y = this->basicScale.y * y;
	this->scale.z = this->basicScale.z * z;
	this->UpdateMatrix();
}
